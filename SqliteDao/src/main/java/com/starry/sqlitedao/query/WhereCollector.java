...
class WhereCollector<T> {
    ...
    WhereCollector(Property[] properties) {
    ...
    void checkProperty(Property property) {
        ...
        if (!found) {
            throw new DaoException("Property '" + property.columnName + "' is not part of Propertys");
        }
    }

    void appendWhereClause(StringBuilder builder, List<Object> values) {
